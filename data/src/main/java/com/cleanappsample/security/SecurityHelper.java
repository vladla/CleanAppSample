package com.cleanappsample.security;
...
public class SecurityHelper {
    private static final String seedKey = "ysgviohn";

    private final static String HEX = "0123456789ABCDEF";
    private final static byte[] key = {0x67, 0x68, 0x36, 0x18, 0x40, 0x25, 0x31, 0x75, 0x6, 0x45, 0x45, 0x16, 0x24, 0x32, 0x20, 0x20};
    ...
    public static String encodeString(String cleartext) {
        ...
        try {
            ...
            byte[] encryptedResult = encrypt(rawKey, cleartext.getBytes());
            String fromHex = toHex(encryptedResult);
            String base64 = new String(android.util.Base64.encode(fromHex.getBytes(), 0));
            return base64;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String decodeString(String encrypted) {
        try {
            ...
            String base64 = new String(android.util.Base64.decode(encrypted, 0));
